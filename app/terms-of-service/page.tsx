      ...
      <div className="prose prose-lg max-w-none space-y-12">
        ...
        <section className="bg-card/50 border border-border/50 rounded-2xl p-8">
          ...
          <p className="text-muted-foreground leading-relaxed">
            These Terms of Service ("Terms") govern your use of CeremonyVerse's wedding planning and sourcing services.
            By engaging our services, you agree to these Terms. Please read them carefully before proceeding.
          </p>
        </section>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card/30 border border-border/50 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li>
                  • By submitting payment, you authorize CeremonyVerse (and its payment processors) to charge the amount
        ...
        <section>
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-primary/30 pl-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Service fees are outlined in your service agreement and vary based on the package selected. All fees are
                clearly disclosed before any commitment is required.
              </p>
            </div>
            ...
            <div className="border-l-4 border-primary/30 pl-6">
              <h3 className="font-semibold text-lg text-foreground mb-3">Milestone-Based Payments (Custom Orders)</h3>
            ...
            <div className="border-l-4 border-secondary/30 pl-6">
              ...
              <ul className="space-y-2 text-muted-foreground text-sm">
                <li>
                  • For payments made via Stripe/PayPal, disputes may also be handled through the processor's dispute
                  process. We will provide documentation such as invoices, written scopes, supplier confirmations,
                  shipping records, and delivery confirmations when applicable.
                </li>
                <li>
            ...
            <div className="border-l-4 border-primary/30 pl-6">
              ...
              <ul className="space-y-2 text-muted-foreground text-sm">
                <li>
                  • Retainers and deposits may be non-refundable once work begins or once supplier orders are placed.
                </li>
                <li>
                  • Custom, made-to-order, or India-sourced items are typically non-refundable after production begins.
                </li>
                <li>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                approvals, and decisions within agreed timeframes.
              </p>
            </div>
            <div className="flex items-start gap-4">
              <CheckCircle className="h-6 w-6 text-secondary flex-shrink-0 mt-1" />
              <p className="text-muted-foreground leading-relaxed">
                <strong className="text-foreground">Payment Obligations:</strong> Make payments according to the agreed
                schedule and payment terms outlined in your service agreement.
              </p>
            </div>
            <div className="flex items-start gap-4">
              <CheckCircle className="h-6 w-6 text-secondary flex-shrink-0 mt-1" />
        ...
        <section className="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800 rounded-2xl p-8">
          ...
          <div className="space-y-4 text-muted-foreground">
            <p className="leading-relaxed">
              While we maintain rigorous verification standards, CeremonyVerse acts as a facilitator and mediator. We
              are not liable for supplier actions beyond our reasonable control.
            </p>
            <p className="leading-relaxed">
            ...
            <p className="leading-relaxed">
              Force majeure events (natural disasters, political instability, pandemics) may affect service delivery. We
              will work diligently to find alternative solutions but cannot guarantee outcomes in such circumstances.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-primary/30 pl-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Clients may terminate services with 30 days written notice. Refunds for unused services will be provided
                minus any non-recoverable costs already incurred.
              </p>
            </div>
            ...
            <div className="border-l-4 border-secondary/30 pl-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                We reserve the right to terminate services for non-payment, breach of terms, or abusive behavior. Full
                refund of unused services will be provided in such cases.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            We may update these Terms periodically. Significant changes will be communicated via email at least 30 days
            before taking effect. Continued use of services after changes constitutes acceptance of updated Terms.
          </p>
        </section>
