...
export const metadata: Metadata = {
  title: "Indian Wedding Planner in New York | CeremonyVerse",
  description:
    "CeremonyVerse provides Indian and fusion wedding planning services in New York, specializing in multi-day celebrations that require cultural understanding, detailed coordination, and seamless execution.",
  keywords: [
    "Indian wedding planner New York",
    "New York Indian wedding",
    "fusion wedding planner NYC",
    "Gujarati wedding planner New York",
    "South Indian wedding planner NY",
  ],
  alternates: {
    canonical: "https://www.ceremonyverse.com/indian-wedding-planner-new-york",
  },
}

export default function IndianWeddingPlannerNewYork() {
  const breadcrumbItems = [
    { name: "Home", url: "https://www.ceremonyverse.com" },
    { name: "Indian Wedding Planner New York", url: "https://www.ceremonyverse.com/indian-wedding-planner-new-york" },
  ]
    ...
    <main className="min-h-screen">
      ...
      <section className="py-20 bg-gradient-to-br from-secondary/10 via-background to-accent/5">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl text-foreground mb-6 leading-tight">
            Indian Wedding Planner in New York
          </h1>
          <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            CeremonyVerse provides Indian and fusion wedding planning services in New York, specializing in multi-day
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-6 max-w-4xl">
          <h2 className="font-serif text-3xl text-foreground mb-8 text-center">Services in New York</h2>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-6 max-w-4xl">
          <h2 className="font-serif text-3xl text-foreground mb-8 text-center">Why Couples in New York Choose Us</h2>
          <ul className="space-y-4 max-w-2xl mx-auto">
            <li className="flex items-start gap-3">
      ...
      <section className="py-20 bg-gradient-to-br from-accent/10 via-background to-secondary/10">
        <div className="container mx-auto px-6 max-w-3xl text-center">
          <h2 className="font-serif text-3xl md:text-4xl text-foreground mb-6">
            Planning an Indian Wedding in New York?
          </h2>
